								...
								<NavigationMenuContent>
									<div className="w-72 gap-4">
										<ul className="flex flex-col">
											{productList.map(({ title, description, icon, href }) => (
												<li key={title}>
													<Link href={href} className="hover:bg-muted flex items-center gap-6 rounded-md p-4 text-sm">
														...
														<div>
															<p className="text-foreground mb-1 leading-none font-semibold">{title}</p>
